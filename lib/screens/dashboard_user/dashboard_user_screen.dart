...
class DashboardUserScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      spacing: 8,
      children: [Text('Signos vitales', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)
      ),
      Row(
        spacing: 8,
        children: [
          MetricCard(value: '72', label: 'BPM', title: 'Frecuencia cardíaca', color: Colors.red),
